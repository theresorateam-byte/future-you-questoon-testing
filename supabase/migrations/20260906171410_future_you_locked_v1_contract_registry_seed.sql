...
values
  ...
  ('topic', 'manage_my_time_better', '1', 'locked',
   '{"title":"Manage My Time Better","user_facing_entry":false}',
  ...
  ('topic', 'stop_putting_things_off', '1', 'locked',
   '{"title":"Stop Putting Things Off","user_facing_entry":false}',
  ...
  ('topic', 'get_my_home_organized', '1', 'locked',
   '{"title":"Get My Home Organized","user_facing_entry":false}',
  ...
  ('topic', 'build_routines_that_work', '1', 'locked',
   '{"title":"Build Routines That Work for Me","user_facing_entry":false}',
